...
//#region node_modules/.nitro/vite/services/ssr/assets/vendor_react-CFh17dx8.js
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C8_HTx03.mjs");
...
var manifest = {
	"44349b834a517b77e70481c86ca918c5795b2c70b992c06bf131eed1cb9c69e5": {
		functionName: "getTracking_createServerFn_handler",
		importer: () => import("./tracking.functions-DBsKMPpg.mjs")
	},
	"c28b865880f1c7b48158fb653c2fe7243ba440c9ef170e0ae220b9c72b71d3aa": {
		functionName: "sendChat_createServerFn_handler",
		importer: () => import("./ai-chat.functions-NfiMSBJb.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DZj4C1IY.mjs").then((n) => n.t),
		import("./start-8zPQKH-p.mjs"),
		import("./vendor_tanstack-DcRIe6u_.mjs").then((n) => n.r)
	]);
	return {
		routerEntry,
		startEntry,
...
//#endregion
export { getRequest as a, useServerFn as c, createStart as i, createMiddleware as n, getServerFnById as o, createServerFn as r, server_exports as s, TSS_SERVER_FUNCTION as t };
